    ...
    public void handle(MouseEvent mouseEvent) {
      ...
      gc.fillRect(0,0,300,500);
         ...
         gc.strokeLine(x,y,x1,y1);
             gc.strokeText("line drawn"+"x:"+x1+"y:"+y1,25,450);
             }
          else if("rectangle".equals(st)){
         gc.strokeRect(x,y,Math.abs(x1-x),Math.abs(y1-y));
             gc.strokeText("Area of rectangle=" + (x1-x)*(y1-y)+"x:"+x1+"y:"+y1,25,450);
             }
          else {
             gc.strokeOval(x,y,Math.abs(x1-x),Math.abs(x1-x));
             gc.strokeText("Area of circle=" + 3.14*(x1-x)*(x1-x)/(37.8*37.8)+"x:"+x1+"y:"+y1,25,450);
             }  
    }
}});
}
